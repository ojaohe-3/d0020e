 ...
 */
@WebServlet("/GetSpecializations/FilterByCode")
public class GetSpecializationFilterByCode extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ProgramInformation[] programs = Neo4jConfigLoader.getApi().filterMethods.filterSpecializationByTag(CourseProgram.ProgramLabels.CODE, request.getParameter("filter"));

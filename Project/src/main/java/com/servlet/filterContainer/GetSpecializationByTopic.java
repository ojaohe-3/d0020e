...
/**
 * Get program when searching by topic
 */
@WebServlet("/GetSpecializations/FilterByTopic")
public class GetSpecializationByTopic extends HttpServlet {

    private static final long serialVersionUID = 1L;

    /**
     * Send JSON array as string with all matching programs when searching for programs by topic
     */
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {

        ProgramInformation[] programs = Neo4jConfigLoader.getApi().filterMethods.filterSpecializationByTopic(request.getParameter("filter"));
